...
const yaml = __importStar(require("yaml-node12"));
 ...
 */
function parseYaml(predicate, filePath) {
    ...
    for (const doc of docs) {
        ...
        if (doc.errors.length > 0) {
            ...
            return {
                ...
                code: analysis_1.AnalysisErrorCode.Parsing,
            };
        }
        /**
        ...
        yaml.visit(doc, {
            Pair(key, pair, ancestors) {
                if (predicate(key, pair, ancestors) && (0, format_1.isSupportedFormat)(pair)) {
                     ...
                     */
                    (0, assert_1.default)(code != null, 'An extracted embedded JavaScript snippet should not be undefined.');
