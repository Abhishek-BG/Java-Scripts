...
function buildVue(input, tryTypeScriptESLintParser) {
    ...
    if (tryTypeScriptESLintParser) {
        options = (0, jsts_1.buildParserOptions)(input, false, jsts_1.parsers.typescript.parser);
        parsed = (0, jsts_1.parseForESLint)(input, jsts_1.parsers.vuejs.parse, options);
    ...
    options = (0, jsts_1.buildParserOptions)(input, true, jsts_1.parsers.javascript.parser);
